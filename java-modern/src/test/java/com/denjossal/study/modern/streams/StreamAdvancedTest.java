...
class StreamAdvancedTest {
    ...
    void shouldPartitionByPrice() {
        var items = List.of(
                new Item("Cheap", 5.0, 1),
                new Item("Mid", 50.0, 1),
                new Item("Expensive", 200.0, 1)
        );
    ...
    void shouldExpandHighQuantityItems() {
        var items = List.of(
                new Item("Solo", 10.0, 1),
                new Item("Multi", 20.0, 3)
        );
